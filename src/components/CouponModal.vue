        ...
        <div class="modal-content border-0 ls">
          ...
          <div class="modal-body bg-warning text-primary">
            <div class="mb-3">
              ...
              <input type="text" class="form-control border-bottom border-primary" id="title" v-model="tempCoupon.title"
                     placeholder="請輸入標題">
            </div>
            <div class="mb-3">
              <label for="coupon_code" class="form-label">優惠碼 *</label>
              <input type="text" class="form-control border-bottom border-primary" id="coupon_code" v-model="tempCoupon.code"
                     placeholder="請輸入優惠碼">
            </div>
            <div class="mb-3">
